          ...
          <div class="">
            ...
            <div class="row">
               <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Danh sách khóa học của <s:property value="trainer.users.fullName"/></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
					  ...
					  <tbody>		  
					  	<s:iterator value="courses">
	                          ...
	                          <td>
	                                ...
	                                <s:if test="%{#stt == 1}"><button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#<s:property value="courseId"/>2"><i class="fa fa-user">
		                                  	</i> <i class="fa fa-ban"></i> Xóa</button></s:if>
	                          	</td>
	                           <!-- Modal block-->
								    ...
								    <div class="modal-content">
								      ...
								      <div class="modal-footer">
								        <button type="button" class="btn btn-default" data-dismiss="modal">Hủy</button>
								      	<button type="button" onclick="location.href='deleteCourse?id=<s:property value="courseId"/>'" class="btn btn-danger">Xóa</button>
								      </div>
								    </div>
								  </div>
								</div>
