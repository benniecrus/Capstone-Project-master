...
insert into Users values('trainer1@gmail.com','123456','Nguyen Nam','0123456789',(SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ),'Hà Nội','nothing','1')
insert into Users values('trainer2@gmail.com','123456','Nguyen Nam','0978524621',(SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ),'Nam Định','nothing','1')
insert into Users values('trainer3@gmail.com','123456','Nguyen Nam','0912253484',(SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ),'Hà Nam','nothing','1')
insert into Users values('trainer4@gmail.com','123456','Nguyen Nam','01234116562',(SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ),'Đà Nẵng','nothing','1')
insert into Users values('trainer5@gmail.com','123456','Nguyen Nam','0972035894',(SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ),'Hồ Chí Minh','nothing','1')
insert into Users values('trainer6@gmail.com','123456','Nguyen Nam','0154648412',(SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ),'Hà Nội','nothing','1')
insert into Users values('trainer7gmail.com','123456','Nguyen Nam','0155788891',(SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ),'Cần Thơ','nothing','1')
insert into Users values('trainer8@gmail.com','123456','Nguyen Nam','0985764123',(SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ),'Hải Phòng','nothing','1')
insert into Users values('trainer9@gmail.com','123456','Nguyen Nam','0965246587',(SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ),'Nam Định','nothing','0')
insert into Users values('trainer10@gmail.com','123456','Nguyen Nam','0978256446',(SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ),'Hà Nội','nothing','0')
insert into Users values('trainer11@gmail.com','123456','Nguyen Nam','0978256446',(SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ),'Hà Nội','nothing','0')
...
/* CourseName, Title, Subtitle, description, primary taught, fee, categoryid, Autoreply, Image, video, rate, languageID, levelID, TrainerID, isDeleted, status, TotalView */

insert into Course values ('CourseName1', 'Title1', 'Subtitle1', 'Descriptuon1','Primary Taught1','100','1','Nothing',null,null,'5','1','1','1','0','1','1')
insert into Course values ('CourseName2', 'Title2', 'Subtitle2', 'Descriptuon2','Primary Taught2','150','5','Nothing',null,null,'4','1','3','2','0','1','2')
insert into Course values ('CourseName3', 'Title3', 'Subtitle3', 'Descriptuon3','Primary Taught3','200','3','Nothing',null,null,'5','1','1','3','0','1','3')
insert into Course values ('CourseName4', 'Title4', 'Subtitle4', 'Descriptuon4','Primary Taught4','80','6','Nothing',null,null,'5','2','4','4','0','1','4')
insert into Course values ('CourseName5', 'Title5', 'Subtitle5', 'Descriptuon5','Primary Taught5','170','8','Nothing',null,null,'3','1','3','5','0','1','5')
insert into Course values ('CourseName6', 'Title6', 'Subtitle6', 'Descriptuon6','Primary Taught6','350','2','Nothing',null,null,'3','1','3','1','0','1','66')
insert into Course values ('CourseName7', 'Title7', 'Subtitle7', 'Descriptuon7','Primary Taught7','200','3','Nothing',null,null,'2','2','2','1','0','1','8')
insert into Course values ('CourseName8', 'Title8', 'Subtitle8', 'Descriptuon8','Primary Taught8','100','9','Nothing',null,null,'3','1','1','3','0','1','0')
insert into Course values ('CourseName9', 'Title9', 'Subtitle9', 'Descriptuon9','Primary Taught9','50','9','Nothing',null,null,'4','1','2','1','0','1','11')
insert into Course values ('CourseName10', 'Title10', 'Subtitle10', 'Descriptuon10','Primary Taught10','250','1','Nothing',null,null,'4','1','1','2','0','1','12')
...
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '2', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '4', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '1', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '2', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '5', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '5', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '2', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '1', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '3', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '4', '0')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '1', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '5', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '2', '1')
insert into Document values((SELECT * FROM OPENROWSET(BULK N'C:\Users\Nam NV\Desktop\image.jpg', SINGLE_BLOB) as UserPicture ), 'thac si', '4', '0')
...
insert into Learner values('5', '0', '1/1/1996','1')
